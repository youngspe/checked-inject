...
export type ToFailable<D> = Extending<Failable, (
    ...
    D extends FailOn<infer D2, any> ? ToFailable_CyclicItem<D2> :
    never
)>
...
export type ToSkippable<D> =
    ...
    D extends FailOn<infer D2, any> ? ToSkippable_CyclicItem<D2> :
    never
...
export type WrapCyclic<D> =
    ...
    D extends FailOn<infer D2, any> ? Cyclic<D2> :
    D
...
declare abstract class _FailOn<D extends CyclicItem, Fl extends Failable> {
    private _b: [D, Fl]
}
...
export type WrapFailOn<D, Fl extends Failable> =
    ...
    D extends FailOn<infer D2, infer Fl2> ? FailOn<D2, Fl | Fl2> :
    D
...
export type GetBaseResource<D> =
    ...
    D extends FailOn<infer D2, any> ? GetBaseResource_CyclicItem<D2> :
    D
...
export type WrapSub<G extends ProvideGraph, D> =
    ...
    D extends FailOn<infer D2, infer Fl> ? WrapFailOn<
